...
1. The original code did not correctly show the images. Fixed an error regarding the type and size of the output image.
2. Be careful when copying and pasting.
3. There is a detail with the convolution code. As it is, it darkens the images.
